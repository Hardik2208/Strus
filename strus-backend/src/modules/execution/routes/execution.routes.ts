...
import { MilestoneDependencyController } from "../controllers/milestone-dependency.controller.js";
...
router.post(
  "/projects/:projectId/milestone-dependencies",
  authenticate,
  MilestoneDependencyController.create
);

router.delete(
  "/projects/:projectId/milestone-dependencies/:dependencyId",
  authenticate,
  MilestoneDependencyController.delete
);
